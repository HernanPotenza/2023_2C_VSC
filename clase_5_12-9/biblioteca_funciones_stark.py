...
def devuelve_cantidad_superheroe_por_color_pelo(lista_personajes: list[dict]) -> dict:
    ...
    for personaje in lista_personajes:                
        ...
        #esto
        # obtener_color_pelo = lambda color_pelo: color_pelo if color_pelo != "" else "No especifica color de pelo"
        # informe_cantidades[obtener_color_pelo(color_pelo)] = informe_cantidades.get(obtener_color_pelo(color_pelo), 0) + 1
