...
img_fondo = pygame.image.load(r'clase_8_26-9\recursos\img\fondo.png')

# Cargamos la imagen de la tabla
img_tabla_puntajes = pygame.image.load(r'clase_8_26-9\recursos\img\tabla_puntajes.png')
pos_img_tabla_puntajes = ((ANCHO_VENTANA - img_tabla_puntajes.get_width()) // 2, 10)

# Creamos el texto del titulo
font_titulo = pygame.font.Font(r'clase_8_26-9\recursos\fonts\Halimount.otf', 50)
...
font_boton = pygame.font.Font(r'clase_8_26-9\recursos\fonts\Halimount.otf', 30)
...
font_tabla = pygame.font.Font(r'clase_8_26-9\recursos\fonts\Halimount.otf', 35)
lista_puntaje_txt = []
...
for item in lista_puntajes:
    ...
    if str(item["nro"]) == '4.' or str(item["nro"]) == '6.':
            lista_puntaje_txt.append((nro_txt, (255, y)))
            print("entrast")
    else:
