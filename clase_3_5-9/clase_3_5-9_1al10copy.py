...
print(f"Ejercicio 1: {semana['miercoles']}") #esto no se hace
...
print(f"Ejercicio 2: {ejercicio_2}")  #esto si se hace
...
titulo = f"El titulo de la pelicula es: {pelicula.get('titualo', 'le erraste')}" 
print(titulo)

ficha = f"""El titulo de la pelicula es: {pelicula.get('titulo')}
El director es: {pelicula.get('director', 'le erraste a la clave')}"""
print(ficha)

for clave in pelicula:
    print(clave, pelicula[clave])
'''
...
print(f"Ejercicio 4: {ejercicio_4_nombre_calle}, {ejercicio_4_altura}")
...
print("Ejercicio 5: {0}".format(continentes["Africa"])) #asi tambien se hace
