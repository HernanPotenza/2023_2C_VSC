...
while dato_ingresado != "Vaccine" and dato_ingresado != "Virus" and dato_ingresado != "Data":
...
print(f"La opcion elegida por la cpu fue: {opcion_cpu}")
...
match dato_ingresado:
    ...
    case "Virus":
        if opcion_cpu == "Virus":
            ...
            mensaje = lista_de_mensajes[1]
#   case _:    el _ es como un default
    case _:
        if opcion_cpu == "Virus":
            mensaje = lista_de_mensajes[1]
        elif opcion_cpu == "Data":
